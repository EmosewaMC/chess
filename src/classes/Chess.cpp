...
//
Bit* Chess::PieceForPlayer(const int playerNumber, const std::string_view texture) {
	Bit* bit = new Bit();
...
void Chess::setUpBoard() {
	...
	for (int i = 0; i < BoardSize; i++) {
		m_Grid[i * 8 + 1].setBit(PieceForPlayer(0, "assets/chess/b_pawn.png"));
		m_Grid[i * 8 + 1].bit()->setPosition(m_Grid[i * 8 + 1].getPosition());
		m_Grid[i * 8 + 6].setBit(PieceForPlayer(1, "assets/chess/w_pawn.png"));
		m_Grid[i * 8 + 6].bit()->setPosition(m_Grid[i * 8 + 6].getPosition());
	}
	
	// setup the rooks
	m_Grid[0].setBit(PieceForPlayer(0, "assets/chess/b_rook.png"));
	m_Grid[0].bit()->setPosition(m_Grid[0].getPosition());
	m_Grid[7].setBit(PieceForPlayer(0, "assets/chess/w_rook.png"));
	m_Grid[7].bit()->setPosition(m_Grid[7].getPosition());
	m_Grid[56].setBit(PieceForPlayer(1, "assets/chess/b_rook.png"));
	m_Grid[56].bit()->setPosition(m_Grid[56].getPosition());
	m_Grid[63].setBit(PieceForPlayer(1, "assets/chess/w_rook.png"));
	m_Grid[63].bit()->setPosition(m_Grid[63].getPosition());

	// setup the knights
	m_Grid[8].setBit(PieceForPlayer(0, "assets/chess/b_knight.png"));
	m_Grid[8].bit()->setPosition(m_Grid[8].getPosition());
	m_Grid[15].setBit(PieceForPlayer(0, "assets/chess/w_knight.png"));
	m_Grid[15].bit()->setPosition(m_Grid[15].getPosition());
	m_Grid[48].setBit(PieceForPlayer(1, "assets/chess/b_knight.png"));
	m_Grid[48].bit()->setPosition(m_Grid[48].getPosition());
	m_Grid[55].setBit(PieceForPlayer(1, "assets/chess/w_knight.png"));
	m_Grid[55].bit()->setPosition(m_Grid[55].getPosition());

	// setup the bishops
	m_Grid[16].setBit(PieceForPlayer(0, "assets/chess/b_bishop.png"));
	m_Grid[16].bit()->setPosition(m_Grid[16].getPosition());
	m_Grid[23].setBit(PieceForPlayer(0, "assets/chess/w_bishop.png"));
	m_Grid[23].bit()->setPosition(m_Grid[23].getPosition());
	m_Grid[40].setBit(PieceForPlayer(1, "assets/chess/b_bishop.png"));
	m_Grid[40].bit()->setPosition(m_Grid[40].getPosition());
	m_Grid[47].setBit(PieceForPlayer(1, "assets/chess/w_bishop.png"));
	m_Grid[47].bit()->setPosition(m_Grid[47].getPosition());

	// setup the queens
	m_Grid[24].setBit(PieceForPlayer(0, "assets/chess/b_queen.png"));
	m_Grid[24].bit()->setPosition(m_Grid[24].getPosition());
	m_Grid[31].setBit(PieceForPlayer(1, "assets/chess/w_queen.png"));
	m_Grid[31].bit()->setPosition(m_Grid[31].getPosition());

	// setup the kings
	m_Grid[32].setBit(PieceForPlayer(0, "assets/chess/b_king.png"));
	m_Grid[32].bit()->setPosition(m_Grid[32].getPosition());
	m_Grid[39].setBit(PieceForPlayer(1, "assets/chess/w_king.png"));
